...
public class KeyListBoxPeer
        ...
        private RenderedModelData(AbstractListComponent listComponent) {
            ...
            for (int i = 0; i < values.length; ++i) {
                ...
                if (renderedValue instanceof StyledListCell) {
                    ...
                    ColorRender.renderToStyle(itemStyle, styledListCell.getForeground(),
                                              styledListCell.getBackground());
    ...
    public void processAction(ContainerInstance ci, Component component, Element actionElement) {
        ci.getUpdateManager().getClientUpdateManager().setComponentAction(component, AbstractListComponent.INPUT_ACTION,
                                                                          null);
    }
