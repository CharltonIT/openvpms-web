...
/**
 * Tests the {@link PatientDocumentActEditor} class with <em>act.patientDocumentAttachment</em> acts.
 *
 * @author Tim Anderson
 */
public class PatientAttachmentActEditorTestCase extends VersionedDocumentActEditorTest {
    ...
    protected DocumentAct createAct() {
        return (DocumentAct) TestHelper.create(PatientArchetypes.DOCUMENT_ATTACHMENT);
    }
