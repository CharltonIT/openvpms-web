 ...
 * @author Tim Anderson
 */
public class SupplierFormActEditorTestCase extends TemplatedDocumentActEditorTest {
    ...
    protected DocumentAct createAct() {
        return (DocumentAct) TestHelper.create(SupplierArchetypes.DOCUMENT_FORM);
    }
