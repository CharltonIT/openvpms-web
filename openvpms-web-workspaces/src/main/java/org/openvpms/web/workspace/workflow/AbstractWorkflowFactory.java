...
public abstract class AbstractWorkflowFactory implements WorkflowFactory {
     ...
     */
    public Workflow createCheckInWorkflow(Party customer, Party patient, User clinician, Context context,
                                          HelpContext help) {
        return new CheckInWorkflow(customer, patient, clinician, context, help);
    }
