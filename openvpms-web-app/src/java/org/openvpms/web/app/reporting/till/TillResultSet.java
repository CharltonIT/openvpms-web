...
/**
 * A query for <em>party.organisationTill</em> objects that optionally constrains them to a specified
 * <em>party.organisationLocation</em>.
 *
 * @author Tim Anderson
 */
public class TillResultSet extends AbstractEntityResultSet<Party> {
    ...
    /**
     * Constructs a <tt>TillResultSet</tt>.
     *
     ...
     */
    public TillResultSet(Party location, ShortNameConstraint archetypes, String value, boolean searchIdentities,
    ...
    protected ArchetypeQuery createQuery() {
        ...
        if (location != null) {
            Date now = new Date();
            query.add(Constraints.join("locations", Constraints.shortName("rel", "entityRelationship.locationTill")));
