...
public abstract class DelegatingContext implements Context {
    ...
    /**
     * The fallback context. May be <tt>null</tt>
     */
    ...
    /**
     * Creates a new <tt>AbstractDelegatingContext</tt> with an optional fallback context.
     *
     * @param context  the context
     * @param fallback the fallback context. May be <tt>null</tt>
     */
     ...
     * If available
     *
     * @return the fallback context, or <tt>null</tt> if there is none
     */
     ...
     * <p/>
     * This first invokes the method on the context. If that returns <tt>null</tt> and the parent context
     * is non-null and not the same context, invokes it on the parent.
     *
     * @param methodName the name of the method to invoke
     * @return the method return value. May be <tt>null</tt>
