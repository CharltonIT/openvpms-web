...
import org.openvpms.web.app.customer.charge.TestChargeEditor;
...
public class CheckInWorkflowTestCase extends AbstractCustomerChargeActEditorTest {
    ...
    public void testCheckInWithInProgressInvoice() {
        ...
        context.setClinician(clinician);
        LayoutContext layoutContext = new DefaultLayoutContext();
        ...
        assertFalse(ObjectUtils.equals(event1, event2));
