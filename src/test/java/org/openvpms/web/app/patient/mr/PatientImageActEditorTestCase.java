...
/**
 * Tests the {@link PatientDocumentActEditor} class with <em>act.patientDocumentImage</em> acts.
 *
 * @author Tim Anderson
 */
public class PatientImageActEditorTestCase extends VersionedDocumentActEditorTest {
    ...
    protected DocumentAct createAct() {
        return (DocumentAct) TestHelper.create(PatientArchetypes.DOCUMENT_IMAGE);
    }
