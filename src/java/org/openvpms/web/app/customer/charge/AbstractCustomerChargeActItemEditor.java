 ...
 */
public abstract class AbstractCustomerChargeActItemEditor extends PriceActItemEditor {
     ...
     */
    public AbstractCustomerChargeActItemEditor(Act act, Act parent, LayoutContext context) {
            ...
            popupEditorMgr.queue(editor, skip, new PopupEditorManager.Listener() {
                public void completed(boolean skipped) {
                    ...
                    if (patientActPopups == 0) {
                        ...
                        getListeners().notifyListeners(AbstractCustomerChargeActItemEditor.this);
                    }
                }
            });
        }
