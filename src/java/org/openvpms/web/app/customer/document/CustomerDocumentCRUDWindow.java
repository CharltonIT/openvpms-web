...
public class CustomerDocumentCRUDWindow extends DocumentCRUDWindow {
     ...
     * @param object
     */
    public CustomerDocumentCRUDWindow(String type, String[] shortNames) {
        super(type, shortNames, Context.getInstance().getCustomer());
    }
