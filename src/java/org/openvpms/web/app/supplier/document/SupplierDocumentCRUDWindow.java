...
public class SupplierDocumentCRUDWindow extends DocumentCRUDWindow {
     ...
     * @param object
     */
    public SupplierDocumentCRUDWindow(String type, String[] shortNames) {
        super(type, shortNames, Context.getInstance().getSupplier());
    }
    /**
