...
public abstract class AbstractEntityQuery<T extends Entity>
    ...
    /**
     * Determines if the query should perform identity searches as well
     * as name searches. If an identity search, the name is used to search for
     * entities with a matching {@link EntityIdentity}.
     *
